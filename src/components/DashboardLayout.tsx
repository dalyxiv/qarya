      ...
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex-1 flex flex-col">
          <header className="h-16 flex items-center gap-3 border-b border-white/5 bg-card/60 backdrop-blur-xl px-4 md:px-6 sticky top-0 z-10 shadow-[0_4px_30px_-10px_rgba(0,0,0,0.8)]">
            <SidebarTrigger />
            <h1 className="text-lg font-semibold tracking-tight bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">
              {title}
            </h1>
          ...
          <footer className="border-t border-white/5 bg-card/40 px-6 py-3 text-[11px] text-muted-foreground flex items-center justify-between">
